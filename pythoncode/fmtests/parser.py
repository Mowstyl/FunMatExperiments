...
raw = pd.read_csv("raw/data_1691139129_2_10.csv", sep=';')
...
times.set_title("Average execution time")
...
sizes.set_title("Average memory usage per node")
